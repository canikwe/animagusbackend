...
Characteristic.create(name: "Hunger", level: 1, decr: 10, incr: 10, recurrence: 2)
Characteristic.create(name: "Thirst", level: 1, decr: 10, incr: 10, recurrence: 2)
Characteristic.create(name: "Sleepiness", level: 1, decr: 10, incr: 10, recurrence: 2)
